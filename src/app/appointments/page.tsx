    ...
    <>
      {submitStatus === "success" && (
        <motion.div
          ...
          className="mb-8 p-6 bg-green-50 border border-green-200 flex items-start gap-4"
        >
      ...
      {submitStatus === "error" && (
        <motion.div
          initial={{ opacity: 0, y: -10 }}
          animate={{ opacity: 1, y: 0 }}
          className="mb-8 p-6 bg-red-50 border border-red-200 flex items-start gap-4"
        >
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        <div className="grid md:grid-cols-2 gap-6">
          <div>
            ...
            <input
              {...register("fullName")}
              type="text"
              className="w-full px-6 py-4 border border-gray-300  focus:ring-2 focus:ring-primary focus:border-primary transition-colors"
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div>
            ...
            <select
              {...register("branch")}
              className="w-full px-6 py-4 border border-gray-300  focus:ring-2 focus:ring-primary focus:border-primary transition-colors bg-white font-medium"
            >
        ...
        <div>
          ...
          <textarea
            {...register("notes")}
            rows={4}
            className="w-full px-6 py-4 border border-gray-300 focus:ring-2 focus:ring-primary focus:border-primary transition-colors resize-none"
        ...
        <button
          ...
          className="w-full py-5 bg-accent text-white font-bold text-lg hover:bg-accent-dark transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 border border-accent/20"
        >
          {isSubmitting ? (
            <>
      ...
      <section className="section-padding bg-[#F7F7F9] relative z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12">
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              <div className="w-16 h-16 mx-auto mb-6 bg-primary/10  flex items-center justify-center group-hover:bg-primary group-hover:text-white transition-all">
            ...
            >
              <div className="w-16 h-16 mx-auto mb-6 bg-green-100  flex items-center justify-center group-hover:bg-green-500 group-hover:text-white transition-all">
